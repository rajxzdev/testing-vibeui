      ...
      <header className="sticky top-0 z-30 border-b border-zinc-200 dark:border-zinc-800/60 bg-white/80 dark:bg-zinc-950/80 backdrop-blur">
        <div className="mx-auto max-w-6xl px-6 h-16 flex items-center justify-between gap-4">
          <Link href="/" className="flex items-center gap-2 shrink-0">
            <svg className="h-6 w-6 dark:drop-shadow-[0_0_8px_rgba(255,255,255,0.5)]" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2L2 22h20L12 2z" /></svg>
      ...
      <div className="mx-auto max-w-6xl px-6 py-8 space-y-6">
        ...
        {tab === 'system' && (
          <section className={card + ' max-w-2xl'}>
            ...
            <p className="text-[11px] text-zinc-500 mt-3 leading-relaxed">Untuk freeze lewat Middleware Vercel, set env <code className="px-1.5 py-0.5 rounded bg-zinc-100 dark:bg-zinc-800">MAINTENANCE_MODE=true</code>.</p>
          </section>
        )}
      </div>
    </main>
