      ...
      <header className="sticky top-0 z-50 border-b border-zinc-200 dark:border-zinc-800/60 bg-white/80 dark:bg-black/70 backdrop-blur">
        <div className="mx-auto max-w-6xl px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-2">
            <svg className="h-6 w-6 text-zinc-900 dark:text-white dark:drop-shadow-[0_0_8px_rgba(255,255,255,0.5)]" viewBox="0 0 24 24" fill="currentColor"><path d="M4 5.5 L12 19 L20 5.5 L16.4 5.5 L12 13.2 L7.6 5.5 Z" /></svg>
      ...
      <section className="relative overflow-hidden vibe-grid">
        <div className="mx-auto max-w-6xl px-6 py-24 md:py-32">
          ...
          <p className={`mt-7 max-w-xl text-lg leading-relaxed ${sub} reveal`}>
            VibeUI mengubah satu kalimat idemu jadi halaman web siap pakai.
      ...
      <section id="fitur" className="mx-auto max-w-6xl px-6 py-20">
        ...
        <div className="mt-10 grid gap-5 md:grid-cols-3">
          <div className={`${card} p-8 md:col-span-2 reveal`}>
            ...
            <h3 className="mt-5 text-xl font-semibold tracking-tight">Generator Desain AI + Perbaikan Cerdas</h3>
          ...
          <div className={`${card} p-8 reveal`}>
            ...
            <h3 className="mt-5 text-xl font-semibold tracking-tight">Pratinjau Aman & Terisolasi</h3>
            <p className={`mt-3 ${sub} leading-relaxed`}>Setiap desain dijalankan di ruang terpisah, jadi hasil AI tidak pernah mengganggu tampilan aplikasi.</p>
          </div>
          <div className={`${card} p-8 reveal`}>
            <Sparkles className="h-5 w-5" />
            <h3 className="mt-5 text-xl font-semibold tracking-tight">Referensi dari Tautan</h3>
            <p className={`mt-3 ${sub} leading-relaxed`}>Tempel tautan halaman yang kamu suka; VibeUI membaca strukturnya dan menjadikannya acuan gaya.</p>
          </div>
          <div className={`${card} p-8 reveal`}>
            <Download className="h-5 w-5" />
            <h3 className="mt-5 text-xl font-semibold tracking-tight">Ekspor Komplit</h3>
            <p className={`mt-3 ${sub} leading-relaxed`}>Salin kode, unduh .html, paket .zip lengkap, plus ringkasan proyek .txt siap kirim ke klien.</p>
          </div>
          <div className={`${card} p-8 reveal relative overflow-hidden`}>
            ...
            <div className="relative">
              ...
              <p className={`mt-3 ${sub} leading-relaxed`}>5 generasi per hari gratis, +2 bonus dari iklan, dan kuota disegarkan otomatis tiap tengah malam.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="mt-10 grid gap-5 md:grid-cols-3">
          <div className={`${card} p-8 reveal`}>
            ...
            <ul className={`mt-6 space-y-2.5 text-sm ${sub}`}>
              {['5 generasi per hari', 'Bonus +2 dari menonton iklan', 'Template dasar', 'Ekspor .html, .zip, brief'].map((f) => (
          ...
          <div className={`${card} p-8 reveal`}>
            ...
            <ul className={`mt-6 space-y-2.5 text-sm ${sub}`}>
              {['Unlimited generasi AI', 'Buka semua 100 template', 'Perbaikan cerdas per komponen', 'Ekspor paket .zip lengkap'].map((f) => (
                <li key={f} className="flex gap-2"><Check className="h-4 w-4 mt-0.5 shrink-0" />{f}</li>))}
            </ul>
