...
Semua teks yang dilihat pengguna sengaja **bebas dari nama vendor & jargon internal**
(nama penyedia AI, layanan cron, pembaca URL, database, jaringan iklan, dsb).
Alasannya: itu detail infrastruktur milik Anda, bukan informasi yang berguna bagi user,
dan menyebutnya membuat produk terlihat seperti rakitan pihak ketiga.

Contoh: "reset via Vercel Cron" → "kuota disegarkan otomatis tiap tengah malam".
Detail teknis tetap ada di README dan `.env.example` — untuk Anda, bukan untuk user.

**Logo** memakai lambang **V** orisinal milik VibeUI
(`M4 5.5 L12 19 L20 5.5 L16.4 5.5 L12 13.2 L7.6 5.5 Z`).
